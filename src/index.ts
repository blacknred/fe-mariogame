...
import { Player, Input, Decoration, Game } from "./lib";
...
addEventListener("load", function () {
  ...
  const game = new Game(
    ...
    new Player(canvas, {
      imgs: [
        { img: playerStandRight, cropWidth: 177, maxWidth: 66, framesQnt: 30 },
        { img: playerStandLeft, cropWidth: 177, maxWidth: 66, framesQnt: 30 },
        { img: playerRunRight, cropWidth: 341, maxWidth: 129, framesQnt: 59 },
        { img: playerRunLeft, cropWidth: 341, maxWidth: 129, framesQnt: 59 },
      ],
      width: 66,
      height: 150,
      x: 100,
